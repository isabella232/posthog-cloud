...
EVENT_USAGE_CACHING_TTL = get_from_env(
    "EVENT_USAGE_CACHING_TTL", 12 * 60 * 60, type_cast=int
)
...
BILLING_NO_PLAN_EVENT_ALLOCATION = get_from_env(
    "BILLING_NO_PLAN_EVENT_ALLOCATION", optional=True, type_cast=int
)
